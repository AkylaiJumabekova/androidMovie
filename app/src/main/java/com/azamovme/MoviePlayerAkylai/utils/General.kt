/*
 *  Created by Akylai Z ㋡ on 11/21/23, 2:02 AM
...
import com.azamovme.MoviePlayerAkylai.data.PhoneData
...
fun setAnimation(
    ...
    anim.setInterpolator(context, com.azamovme.MoviePlayerAkylai.R.anim.over_shoot)
...
fun View.slideTop(animTime: Long, startOffset: Long) {
    val slideUp = AnimationUtils.loadAnimation(App.instance, com.azamovme.MoviePlayerAkylai.R.anim.slide_top).apply {
        duration = animTime
...
fun animationTransactionClearStack(clearFragmentID: Int): NavOptions.Builder {
    ...
    navBuilder.setEnterAnim(com.azamovme.MoviePlayerAkylai.R.anim.from_right).setExitAnim(com.azamovme.MoviePlayerAkylai.R.anim.to_left)
        .setPopEnterAnim(com.azamovme.MoviePlayerAkylai.R.anim.from_left).setPopExitAnim(com.azamovme.MoviePlayerAkylai.R.anim.to_right)
...
fun View.slideUp(animTime: Long, startOffset: Long) {
    val slideUp = AnimationUtils.loadAnimation(App.instance, com.azamovme.MoviePlayerAkylai.R.anim.slide_up).apply {
        duration = animTime
        interpolator = FastOutSlowInInterpolator()
        this.startOffset = startOffset
    }
...
fun View.slideStart(animTime: Long, startOffset: Long, hide: View? = null) {
    val slideUp = AnimationUtils.loadAnimation(App.instance,com.azamovme.MoviePlayerAkylai. R.anim.slide_start).apply {
