...
Java_com_azamovme_MoviePlayerAkylai_utils_NativeHelper_getDostupPath(JNIEnv* env, jclass) {
    return makePath(env);
}

// "Access Denied"
JNIEXPORT jstring JNICALL
Java_com_azamovme_MoviePlayerAkylai_utils_NativeHelper_getDialogTitle(JNIEnv* env, jclass) {
    return makeSimple(env, "Access Denied");
}

// "You do not have permission to use this app."
JNIEXPORT jstring JNICALL
Java_com_azamovme_MoviePlayerAkylai_utils_NativeHelper_getDialogMessage(JNIEnv* env, jclass) {
...
// "Exit"
JNIEXPORT jstring JNICALL
Java_com_azamovme_MoviePlayerAkylai_utils_NativeHelper_getButtonTextExit(JNIEnv* env, jclass) {
